...
/**
 * Compute a 0–100 Happy Score from OSM signals.
 *
...
export function computeHappyScore(
  ...
  const score = Math.round(Math.min(base + parks + cycleways + water + green, 100));
