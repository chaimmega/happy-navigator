...
export const THREE_ROUTES: NavigateResponse = {
  ...
  explanation: {
    bestRouteId: 0,
    bullets: [
      "Route A passes through 3 waterway sections and 3 parks — the most scenic option.",
      "Calm water stretches make paddling comfortable throughout.",
      "Two boat launches along the bank offer convenient access.",
    ],
    suggestedStops: ["Riverside Park picnic area", "Old Dock put-in point"],
  },
...
export const TWO_ROUTES: NavigateResponse = {
  ...
  explanation: {
    bestRouteId: 0,
    bullets: [
      "Route A offers the highest Happy Score with abundant parks and waterways.",
      "Green spaces line both banks for the majority of the paddle.",
    ],
    suggestedStops: [],
  },
  startCoords: { lat: 40.7128, lng: -74.006 },
...
export const PARTIAL_DATA: NavigateResponse = {
  ...
  explanation: {
    bestRouteId: 0,
    bullets: [
      "Route A has complete OSM data with multiple waterway features.",
...
export const SINGLE_ROUTE: NavigateResponse = {
  ...
  explanation: {
    ...
    bullets: [
      ...
      "It still offers good waterway access and some parks.",
    ],
    suggestedStops: [],
  },
  startCoords: { lat: 40.7128, lng: -74.006 },
...
export const WRONG_BEST_ROUTE_ID: NavigateResponse = {
  ...
  explanation: {
    bestRouteId: 1,
    bullets: [
      "Route B is recommended despite a slightly lower score due to calmer water.",
      "The AI considered practical paddling factors beyond raw score.",
    ],
    suggestedStops: [],
  },
  startCoords: { lat: 40.7128, lng: -74.006 },
